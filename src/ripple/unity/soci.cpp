...
#include <backends/empty/factory.cpp>
#include <backends/empty/row-id.cpp>
#include <backends/empty/session.cpp>
#include <backends/empty/standard-into-type.cpp>
#include <backends/empty/standard-use-type.cpp>
#include <backends/empty/statement.cpp>
#include <backends/empty/vector-into-type.cpp>
#include <backends/empty/vector-use-type.cpp>

#include <backends/empty/blob.cpp>
