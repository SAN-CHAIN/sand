...
HandlerTable HANDLERS({
    ...
    {   "balance_dump",         byRef (&doBalanceDump),         Role::ADMIN, NEEDS_CURRENT_LEDGER },
    ...
    {   "dividend",             byRef (&doDividend),            Role::ADMIN,   NEEDS_CURRENT_LEDGER     },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "contribute_power",     byRef (&doContributePower),     Role::ADMIN,   NEEDS_CURRENT_LEDGER     },
