...
bool transResultInfo (TER code, std::string& token, std::string& text)
{
    ...
    TxResultInfo const results[] =
    {
        ...
        { tecNO_DST,                "tecNO_DST",                "Destination does not exist. Send SAN to create it."            },
        { tecNO_DST_INSUF_XRP,      "tecNO_DST_INSUF_SAN",      "Destination does not exist. Too little SAN sent to create it." },
        ...
        { tecUNFUNDED_ADD,          "tecUNFUNDED_ADD",          "Insufficient SAN balance for WalletAdd."                       },
        { tecUNFUNDED_OFFER,        "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                   },
        { tecUNFUNDED_PAYMENT,      "tecUNFUNDED_PAYMENT",      "Insufficient SAN balance to send."                             },
        ...
        { temBAD_FEE,               "temBAD_FEE",               "Invalid fee, negative or not SAN."                             },
        ...
        { temBAD_SEND_XRP_LIMIT,    "temBAD_SEND_SAN_LIMIT",    "Malformed: Limit quality is not allowed for SAN to SAN."       },
        { temBAD_SEND_XRP_MAX,      "temBAD_SEND_SAN_MAX",      "Malformed: Send max is not allowed for SAN to SAN."            },
        { temBAD_SEND_XRP_NO_DIRECT,"temBAD_SEND_SAN_NO_DIRECT","Malformed: No Ripple direct is not allowed for SAN to SAN."    },
        { temBAD_SEND_XRP_PARTIAL,  "temBAD_SEND_SAN_PARTIAL",  "Malformed: Partial payment is not allowed for SAN to SAN."     },
        { temBAD_SEND_XRP_PATHS,    "temBAD_SEND_SAN_PATHS",    "Malformed: Paths are not allowed for SAN to SAN."              },
