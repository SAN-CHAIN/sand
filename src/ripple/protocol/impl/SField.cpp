...
SField const sfDividendState     = make::one(&sfDividendState,     STI_UINT8, 181, "IncentiveState");
SField const sfDividendType      = make::one(&sfDividendType,      STI_UINT8, 182, "Incentiveype");
...
SField const sfDividendLedger    = make::one(&sfDividendLedger,    STI_UINT32, 181, "IncentiveBaseLedger");
...
SField const sfDividendCoins    = make::one(&sfDividendCoins,    STI_UINT64, 181, "IncentiveCoins");
...
//SField const sfDividendHash    = make::one(&sfDividendHash,    STI_HASH256, 181, "IncentiveHash");
//SField const sfDividendMarker  = make::one(&sfDividendMarker,  STI_HASH256, 182, "IncentiveMarker");
